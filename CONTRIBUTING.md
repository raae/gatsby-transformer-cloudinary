...
To uphold a welcoming environment, we as contributors pledge to do Our best to make participation in Cloudinary plugins a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation. Please report bad behavior to our cloudinaryGal@cloudinary.com.

[Read the full code of conduct](https://www.gatsbyjs.com/contributing/code-of-conduct/).

✅ Write a Cloudinary Code of Conduct
...
| `help-wanted` | The Cloudinary plugin team would appreciate help from the community in resolving these issues. |
| `beginner` | Less complex issues which would be good first issues to work on for users who want to contribute to a Cloudinary plugin. |
...
| `needs-review` | Pull requests which need code review, and approval from maintainers or Cloudinary plugin team. |
| `under-review` | Pull requests being reviewed by maintainers or Cloudinary plugin team. |
